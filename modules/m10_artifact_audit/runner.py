...
from qdp_paths import BASE_TEMPLATE, CANDIDATE_VALIDATOR, DEEP_RESEARCH_REPORT, FORK_INTAKE_FORM, MODULES, SCHEMA, repo_rel
...
def run_artifact_audit(candidate: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    diagnostics = {
        "artifact_id": "QDP_V10_6_M10_ARTIFACT_AUDIT_REPORT",
        "module_id": "M10",
...
def run_selftests(
    ...
    return {
        "artifact_id": "QDP_V10_6_M10_SELFTEST_REPORT",
        "module_id": "M10",
        "timestamp_utc": datetime.now(timezone.utc).isoformat(),
        "visible_source_only": True,
