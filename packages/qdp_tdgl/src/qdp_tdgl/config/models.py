...
from qdp_meta_materials.adapters.tdgl import TDGLResolvedParameterSet
...
class MaterialsConfig(StrictModel):
    registry_source: str = "qdp_meta_materials.seed.stable"
    registry_root: str | None = None
    adapter_id: str
    adapter_version: str | None = None
    material_system_id: str
    genome_id: str | None = None
    material_system_name: str | None = None
    runtime_family: str | None = None
    source_artifacts: list[str] = Field(default_factory=list)
    supported_geometry_families: list[str] = Field(default_factory=list)
    resolved_tdgl_parameters: TDGLResolvedParameterSet | None = None
    notes: str = ""
