...
from qdp_tdgl.workflows.run_matrix import load_experiment_matrix, run_experiment_matrix
...
def run_seeded_vortex_validation(
    ...
    *,
    ...
    if "reference_runs" not in raw_manifest:
        from qdp_tdgl.workflows.seeded_vortex_suite import run_seeded_vortex_validation_suite
