...
from qdp_tdgl.config.loaders import repo_root, tdgl_config_root, tdgl_validation_root
from qdp_tdgl.exceptions import ManifestValidationError, TDGLRFError
...
def default_phase2_4a_validation_manifest_path() -> Path:
    return (tdgl_validation_root() / "seeded_vortex_phase2_4a_validation_manifest.yaml").resolve()


def _phase2_4a_validation_schema_path() -> Path:
    return tdgl_config_root() / "seeded_vortex_phase2_4a_validation_manifest.schema.json"
